...
const Map<String, String> kEnStrings = {
  ...
  'couch_live_title': 'Pick Together',
  'couch_live_subtitle': 'Live: two phones, one decision',
  'couch_live_badge': 'LIVE',
  'couch_invite_waiting': '{} is waiting for you!',
  'couch_login_required': 'Sign in to use Pick Together.',
  'couch_pick_friend': 'Who are you picking with?',
  'couch_pick_friend_desc':
      'Pick a friend and we\'ll build a deck just for the two of you. The first title you both like wins!',
  'couch_no_friends': 'Add a friend from the Social tab first.',
  'couch_building_deck': 'Building your deck…',
  'couch_waiting_friend': '{} hasn\'t joined yet',
  'couch_you': 'You',
  'couch_like': 'Like',
  'couch_skip': 'Pass',
  'couch_deck_done_title': 'You\'re done!',
  ...
  'couch_view_detail': 'View Details',
  'couch_close': 'Close',
  ...
  'onboarding_culture_title': 'Which cinemas feel closest to you?',
  'onboarding_culture_subtitle':
      'Choose as many as you like. You can change this later.',
  'culture_prefer': 'More',
  'culture_explore': 'Sometimes',
  'culture_avoid': 'Show less',
  'culture_hollywood': 'Hollywood / American Cinema',
  'culture_turkish': 'Turkish Cinema',
  'culture_korean': 'Korean Cinema',
  'culture_japanese': 'Japanese Cinema',
  'culture_indian': 'Indian Cinema',
  'culture_iranian': 'Iranian Cinema',
  'culture_european': 'European Cinema',
  'culture_latin_american': 'Latin American Cinema',
  'culture_east_asian': 'Other East Asian Cinemas',
  'culture_short_hollywood': 'Hollywood',
  'culture_short_turkish': 'Turkish',
  'culture_short_korean': 'Korean',
  'culture_short_japanese': 'Japanese',
  'culture_short_indian': 'Indian',
  'culture_short_iranian': 'Iranian',
  'culture_short_european': 'European',
  'culture_short_latin_american': 'Latin American',
  'culture_short_east_asian': 'East Asian',
  'dna_culture': 'Your cinema geography: {cultures}.',
  'reco_reason_culture': 'Because you prefer {x}',
  'cultural_preferences_title': 'Your cinema culture preferences',
  'cultural_preferences_profile_desc':
      'Edit your Korean, European, Turkish and other cinema preferences',
  'cultural_preferences_edit_desc':
      'Choose which cinemas you want to see more often in recommendations.',
  'profile_save': 'Save',
  'discovery_context_title': 'What do you want to watch tonight?',
  'discovery_context_desc': 'Tune recommendations for what you want right now',
  'discovery_context_sheet_desc':
      'These choices only affect recommendations in this session.',
  'discovery_media_title': 'What should we watch?',
  'discovery_duration_title': 'How long?',
  'discovery_familiarity_title': 'How much discovery?',
  'discovery_origin_title': 'Which cinemas?',
  'discovery_origin_hint':
      'Preferred Regions: your saved cinema cultures (e.g. Local, European).',
  'discovery_any': 'Any',
  'discovery_movie': 'Movie',
  'discovery_tv': 'TV show',
  'discovery_short': 'Short',
  'discovery_medium': 'Medium',
  'discovery_long': 'Long',
  'discovery_safe': 'Safe pick',
  'discovery_balanced': 'Balanced',
  'discovery_surprise': 'Surprise me',
  'discovery_local': 'Preferred Regions',
  ...
  'dismiss_not_now': 'Not in the mood right now',
  'dismiss_already_watched': 'Already watched it',
  'dismiss_too_long': 'Too long',
  'dismiss_wrong_culture': 'This cinema culture isn’t for me',
  'dismiss_wrong_genre': 'This genre isn’t for me',
  'dismiss_not_interested': 'This title doesn’t interest me',
  'dismiss_feedback_skip': 'Skip without answering',
  ...
  'semantics_open_person': 'Open {} cast profile',
  'semantics_open_title': 'Open details for {}',
  'semantics_edit_top_list': 'Edit {}',
  'semantics_clear_search_history': 'Clear search history',
