...
const Map<String, String> kTrStrings = {
  ...
  'onboarding_culture_title': 'Hangi sinemalara yakın hissediyorsun?',
  'onboarding_culture_subtitle':
      'Birden fazla seçebilirsin. Fikrini sonra değiştirebilirsin.',
  'culture_prefer': 'Daha çok',
  'culture_explore': 'Ara sıra',
  'culture_avoid': 'Az göster',
  'culture_hollywood': 'Hollywood / Amerikan Sineması',
  'culture_turkish': 'Türk Sineması',
  'culture_korean': 'Kore Sineması',
  'culture_japanese': 'Japon Sineması',
  'culture_indian': 'Hint Sineması',
  'culture_iranian': 'İran Sineması',
  'culture_european': 'Avrupa Sineması',
  'culture_latin_american': 'Latin Amerika Sineması',
  'culture_east_asian': 'Diğer Uzak Doğu Sinemaları',
  'culture_short_hollywood': 'Hollywood',
  'culture_short_turkish': 'Türk',
  'culture_short_korean': 'Kore',
  'culture_short_japanese': 'Japon',
  'culture_short_indian': 'Hint',
  'culture_short_iranian': 'İran',
  'culture_short_european': 'Avrupa',
  'culture_short_latin_american': 'Latin Amerika',
  'culture_short_east_asian': 'Uzak Doğu',
  'dna_culture': 'Sinema coğrafyan: {cultures}.',
  'reco_reason_culture': '{x} tercih ettiğin için',
  'cultural_preferences_title': 'Sinema kültürü tercihlerin',
  'cultural_preferences_profile_desc':
  ...
  'profile_save': 'Kaydet',
  'discovery_context_title': 'Bu akşam ne izlemek istiyorsun?',
  'discovery_context_desc': 'O anki isteğine göre önerileri ayarla',
  'discovery_context_sheet_desc':
      'Bu seçimler yalnızca bu oturumdaki önerileri etkiler.',
  'discovery_media_title': 'Ne izleyelim?',
  'discovery_duration_title': 'Ne kadar uzun?',
  'discovery_familiarity_title': 'Ne kadar keşif?',
  'discovery_origin_title': 'Hangi sinemalar?',
  ...
  'discovery_tv': 'Dizi',
  'discovery_short': 'Kısa',
  'discovery_medium': 'Orta',
  'discovery_long': 'Uzun',
  'discovery_safe': 'Güvenli',
  'discovery_balanced': 'Dengeli',
  'discovery_surprise': 'Sürpriz',
  'discovery_local': 'Favori Bölgelerim',
  ...
  'dismiss_not_now': 'Şu an havasında değilim',
  'dismiss_already_watched': 'Zaten izledim',
  'dismiss_too_long': 'Fazla uzun',
  'dismiss_wrong_culture': 'Bu sinema kültürü bana göre değil',
  'dismiss_wrong_genre': 'Bu tür bana göre değil',
  'dismiss_not_interested': 'Bu yapım ilgimi çekmedi',
  'dismiss_feedback_skip': 'Cevap vermeden geç',
  ...
  'auth_guest_data_merged_all':
      '{} puanın, {} izleme listesi kaydın ve {} Top 20 başlığın hesabına taşındı.',
  ...
  'auth_guest_data_merged_watchlist_favorites':
      '{} izleme listesi kaydın ve {} Top 20 başlığın hesabına taşındı.',
  ...
  'lang_en': 'İngilizce yapımlar',
  'lang_en_short': 'İngilizce',
  ...
  'semantics_open_person': '{} oyuncu profilini aç',
  'semantics_open_title': '{} ayrıntılarını aç',
  'semantics_edit_top_list': '{} listesini düzenle',
  'semantics_clear_search_history': 'Arama geçmişini temizle',
  ...
  'popular_top_movies_subtitle':
      'Üyelerin profil vitrinine (Top 20) en çok eklediği başyapıtlar',
  'popular_top_tv_title': 'Cinema+ Top 20 Dizi',
  'popular_top_tv_subtitle':
      'Üyelerin profil vitrinine (Top 20) en çok eklediği başyapıt diziler',
