...
$possiblePaths[] = __DIR__ . '/src/fcm-service-account.json';
$possiblePaths[] = __DIR__ . '/fcm-service-account.json';
$possiblePaths[] = dirname(__DIR__) . '/fcm-service-account.json';
...
if (!$saPath) {
    ...
    echo "   " . __DIR__ . DIRECTORY_SEPARATOR . "fcm-service-account.json\n\n";
    exit(1);
}
...
try {
    ...
    if (!$deviceToken) {
        ...
        echo "php test_fcm.php <CIHAZ_FCM_TOKENU>\n\n";
