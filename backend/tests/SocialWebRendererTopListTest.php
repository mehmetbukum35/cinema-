...
final class SocialWebRendererTopListTest extends TestCase
{
    public function testLoadsSeparatedTopTwentyInUserOrderWithLocaleFallback(): void
    {
        ...
        $db->exec('CREATE TABLE titles (tmdb_id INTEGER, is_tv INTEGER, locale TEXT, title TEXT, poster_path TEXT, vote_average REAL, release_date TEXT)');
        ...
        $db->exec("INSERT INTO titles VALUES
            (101, 0, 'tr', 'Üçüncü Film', '/3.jpg', 8.1, '2003-01-01'),
            (102, 0, 'tr', 'Birinci Film', '/1.jpg', 8.9, '2001-01-01'),
            (103, 0, 'und', 'Fallback Film', '/2.jpg', 8.4, '2002-01-01'),
            (201, 1, 'tr', 'Birinci Dizi', '/tv.jpg', 9.0, '2020-01-01')");
